...
python main.py --program graph_coloring --sched 0 --no-sim 500000 --fault-interval 1 --graph-names random_graph_diff_degree_2 --fault-prob 1.0
python main.py --program graph_coloring --sched 0 --no-sim 500000 --fault-interval 2 --graph-names random_graph_diff_degree_2 --fault-prob 1.0
python main.py --program graph_coloring --sched 0 --no-sim 500000 --fault-interval 4 --graph-names random_graph_diff_degree_2 --fault-prob 1.0
