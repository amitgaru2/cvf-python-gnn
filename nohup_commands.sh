...
# python main.py --program dijkstra_token_ring --sched 0 --no-sim 500000 --fault-interval 1 --graph-names implicit_graph_n15 --fault-prob 1.0
# python main.py --program dijkstra_token_ring --sched 0 --no-sim 500000 --fault-interval 2 --graph-names implicit_graph_n15 --fault-prob 1.0
# python main.py --program dijkstra_token_ring --sched 0 --no-sim 500000 --fault-interval 4 --graph-names implicit_graph_n15 --fault-prob 1.0
python main.py --program maximal_matching --graph-names graph_1, graph_2 --fault-prob 1.0
