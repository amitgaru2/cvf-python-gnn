...
python simulate.py --program graph_coloring --sched 0 --no-sim 500000 --fault-interval 1 --graph-names graph_7 --fault-prob 1.0 --simulation-type controlled_at_node --controlled-at-node 9
