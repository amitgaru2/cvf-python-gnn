...
python main.py --program graph_coloring --sched 0 --no-sim 100000 --fault-interval 10 --graph-names graph_7 --fault-prob 1.0
...
python main.py --program graph_coloring --sched 0 --no-sim 500000 --fault-interval 10 --graph-names graph_7 --fault-prob 1.0
