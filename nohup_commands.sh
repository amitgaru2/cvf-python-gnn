...
python simulate.py --program maximal_matching --sched 0 --no-sim 100000 --fault-interval 2 --graph-names star_graph_0_n7 --fault-prob 1.0 --simulation-type random_start_at_node --controlled-at-node 0
python simulate.py --program maximal_matching --sched 0 --no-sim 100000 --fault-interval 2 --graph-names star_graph_0_n7 --fault-prob 1.0 --simulation-type random_start_at_node --controlled-at-node 4
python simulate.py --program maximal_matching --sched 0 --no-sim 100000 --fault-interval 2 --graph-names star_graph_0_n7 --fault-prob 1.0 --simulation-type random_start_at_node --controlled-at-node 7
python simulate.py --program maximal_matching --sched 0 --no-sim 100000 --fault-interval 2 --graph-names star_graph_0_n7 --fault-prob 1.0 --simulation-type random_start_at_node --controlled-at-node 9
